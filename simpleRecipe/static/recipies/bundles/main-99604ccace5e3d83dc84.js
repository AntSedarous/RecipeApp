    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        list.map(function (item) {
          return _react2.default.createElement(TestChild, { key: item.pk,
            title: item.name,
...
var TestChild = function (_React$Component2) {
  _inherits(TestChild, _React$Component2);

  function TestChild() {
    _classCallCheck(this, TestChild);

    return _possibleConstructorReturn(this, (TestChild.__proto__ || Object.getPrototypeOf(TestChild)).apply(this, arguments));
  }
...
_reactDom2.default.render(_react2.default.createElement(Test, null), document.getElementById('reactapp'));
